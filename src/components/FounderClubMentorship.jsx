...
const FounderClubMentorship = () => {
    ...
    return (
        <section id="mentorship" className="relative w-full py-12 md:py-32 bg-background overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
                    ...
                    <div className="space-y-8 text-center md:text-left flex flex-col items-center md:items-start">
                        ...
                        >
                            ...
                            <p className="text-base md:text-xl text-text-secondary leading-relaxed max-w-xl tracking-wide md:tracking-normal font-light">
                        ...
                        >
                            {benefits.map((benefit, index) => (
                                <div key={index} className="flex items-center gap-3 md:gap-4 group">
                                    ...
                                    <span className="text-base md:text-xl text-text-primary font-medium tracking-tight">{benefit}</span>
                                </div>
                            ))}
                        </motion.div>
                        ...
                        >
                            <div className="flex flex-col sm:flex-row items-center sm:items-center gap-6">
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="group relative px-6 py-3 md:px-8 md:py-4 bg-primary text-white text-sm md:text-base font-bold rounded-full overflow-hidden shadow-lg hover:shadow-primary/50 transition-all duration-300"
                                >
                    ...
                    >
                        <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-surface/50 backdrop-blur-sm p-2 md:p-4 w-full max-w-[600px]">
                            <div className="h-48 md:h-[350px] w-full rounded-xl bg-gradient-to-br from-surface to-background relative overflow-hidden group">
