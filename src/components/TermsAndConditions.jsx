        ...
        <section className="w-full min-h-screen bg-black text-white py-20 px-6 md:px-20">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-16 border-b border-white/10 pb-8">
                    <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-6">Terms & Conditions</h1>
                ...
                <div className="mt-20 pt-10 border-t border-white/10 text-gray-400 text-sm space-y-2">
                    <h3 className="text-white font-semibold text-base mb-1">Business & Billing Information</h3>
