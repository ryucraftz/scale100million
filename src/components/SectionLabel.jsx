...
export default function SectionLabel({ number, inverted = false }) {
    return (
      ...
      */}
            <div className="sticky top-6 md:top-28 left-1 md:left-6 w-max pointer-events-auto scale-[0.6] md:scale-100 origin-top-left transition-transform duration-300">
                <motion.div
