...
export default function PartnerWithUs() {
    return (
        <section id="partner" className="py-24 px-6 md:px-12 bg-white text-text-primary overflow-hidden relative">
            <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 bg-gray-100 backdrop-blur-md mb-8">
                    ...
                    <div className="mt-8 flex flex-col items-center gap-2">
                        ...
                        <p className="text-gray-900 font-bold text-xl">Built together.</p>
                    </div>
