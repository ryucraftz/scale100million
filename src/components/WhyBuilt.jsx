        ...
        <section id="why-built" className="py-20 md:py-32 px-5 md:px-12 bg-black text-white relative overflow-hidden">
            ...
            >
                ...
                >
                    ...
                    <motion.div
                        className="hidden md:flex absolute top-[35%] md:top-1/3 left-1/2 w-[110vw] md:w-[80vw] max-w-[1000px] aspect-square pointer-events-none z-[-1] mix-blend-screen opacity-50 md:opacity-60 items-center justify-center"
                    ...
                    <div className="relative inline-flex items-center gap-2 md:gap-3 px-3 py-1.5 md:px-4 md:py-2 border border-white/10 md:border-white/5 text-gray-400 md:text-gray-500 text-[12px] sm:text-xs font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] mb-24 md:mb-32 mix-blend-screen bg-black/50 md:bg-transparent rounded-full backdrop-blur-md md:backdrop-blur-none">
                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse" />
                        <span className="relative z-10">The Operation Model</span>
                    </div>

                    {/* Ultra-Refined Typography */}
                    <div className="max-w-7xl mx-auto px-5 md:px-6 relative z-10 mb-10 md:mb-40 pt-16 md:pt-32">
                    ...
                    <motion.div
                        ...
                        className="hidden md:block relative z-10 text-[18vw] md:text-[12vw] xl:text-[14vw] font-black tracking-tighter uppercase select-none w-full text-center overflow-hidden whitespace-nowrap leading-none px-4 md:px-0"
