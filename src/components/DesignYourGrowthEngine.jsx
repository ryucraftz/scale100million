...
export default function DesignYourGrowthEngine() {
    return (
        <section id="growth-engine" className="py-24 px-6 md:px-12 bg-white text-text-primary relative overflow-hidden border-t border-gray-200 flex items-center justify-center">
